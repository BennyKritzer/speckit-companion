...
export const DEFAULT_WORKFLOW: WorkflowConfig = {
    ...
    steps: [
        ...
        { name: WorkflowSteps.CLARIFY, label: 'Clarify', command: 'speckit.clarify', actionOnly: true },
        ...
        { name: WorkflowSteps.ANALYZE, label: 'Analyze', command: 'speckit.analyze', actionOnly: true },
        { name: WorkflowSteps.IMPLEMENT, label: 'Implement', command: 'speckit.implement', actionOnly: true },
        { name: WorkflowSteps.CHECKLIST, label: 'Checklist', command: 'speckit.checklist', subDir: 'checklists', includeRelatedDocs: true, actionOnly: true },
        { name: WorkflowSteps.GIT_VALIDATE, label: 'Git Validate', command: 'speckit.git-validate', actionOnly: true },
    ],
