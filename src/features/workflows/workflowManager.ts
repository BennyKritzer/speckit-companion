...
export const DEFAULT_WORKFLOW: WorkflowConfig = {
    ...
    steps: [
        ...
        { name: WorkflowSteps.CHECKLIST, label: 'Checklist', command: 'speckit.checklist', subDir: 'checklists', includeRelatedDocs: true, actionOnly: true, optional: true },
        { name: WorkflowSteps.GIT_VALIDATE, label: 'Git Validate', command: 'speckit.git-validate', actionOnly: true, optional: true },
    ],
